        ...
        <div class="row">
            <div class="col-md-6">
                <div class="main-card mb-3 card">
                    <div class="card-body"><h5 class="card-title">List Label</h5>
                              ...
                              <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                  <div class="widget-content-left mr-2">
                                    <div class="custom-checkbox custom-control"><input type="checkbox" id="exampleCustomCheckbox0" class="custom-control-input"><label class="custom-control-label"
                                                                                                                                                                        for="exampleCustomCheckbox0">&nbsp;</label>
                                    </div>
                                  </div>
                                  <div class="widget-content-left">
                                    <div class="widget-heading">Normal
                                    </div>
                                  </div>
                            ...
                            <li class="list-group-item">
                              ...
                              <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                  ...
                                  <div class="widget-content-left">
                                    <div class="widget-heading">Cataract
                                    </div>
                                  </div>
                                  <div class="widget-content-right widget-content-actions">
                                    <button class="border-0 btn-transition btn btn-outline-danger">
                            ...
                            <li class="list-group-item">
                              ...
                              <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                  ...
                                  <div class="widget-content-left">
                                    <div class="widget-heading">Uveitis
                                    </div>
                                  </div>
                                  <div class="widget-content-right widget-content-actions">
                                    <button class="border-0 btn-transition btn btn-outline-danger">
                            ...
                            <li class="list-group-item">
                              ...
                              <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                  ...
                                  <div class="widget-content-left">
                                    <div class="widget-heading">Crossed Eye
                                    </div>
                                  </div>
                                  <div class="widget-content-right widget-content-actions">
                                    <button class="border-0 btn-transition btn btn-outline-danger">
                            ...
                            <li class="list-group-item">
                              ...
                              <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                  ...
                                  <div class="widget-content-left">
                                    <div class="widget-heading">Bulging Eye
                                    </div>
                                  </div>
                                  <div class="widget-content-right widget-content-actions">
                                    <button class="border-0 btn-transition btn btn-outline-danger">
            ...
            <div class="col-md-6">
                <div class="main-card mb-3 card">
                    <div class="card-body"><h5 class="card-title">Add New Label</h5>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            subheading: 'Tambah, edit atau delete label panyakit.',
            icon: 'pe-7s-albums icon-gradient bg-premium-dark',
        }),
