...
export default new Router({
    ...
    routes: [
        ...
        {
            path: '/collect/common/list',
            name: 'common_list',
            component: () => import('../DemoPages/Collect/CommonList.vue'),
        },
        {
            path: '/collect/common/add',
            name: 'common_add',
        ...
        },
        {
            ...
            name: 'instruction',
            component: () => import('../DemoPages/Documentation/Instruction.vue'),
        },
        {
            path: '/documentation/project',
            name: 'project_description',
            component: () => import('../DemoPages/Documentation/ProjectDescription.vue'),
        },
    ]
})
